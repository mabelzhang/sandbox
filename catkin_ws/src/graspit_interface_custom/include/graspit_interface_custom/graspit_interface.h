...
#include <graspit_interface_custom/PlanGraspsAction.h>
...
private:
  ...
  actionlib::SimpleActionServer<graspit_interface_custom::PlanGraspsAction> *plan_grasps_as;
  graspit_interface_custom::PlanGraspsFeedback feedback_;
  graspit_interface_custom::PlanGraspsResult result_;
  graspit_interface_custom::PlanGraspsGoal goal;
  ...
  void PlanGraspsCB(const graspit_interface_custom::PlanGraspsGoalConstPtr &goal);
