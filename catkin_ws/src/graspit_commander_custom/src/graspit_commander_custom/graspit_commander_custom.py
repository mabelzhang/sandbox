...
# Custom ones with n_best_grasps parameter added
from graspit_interface_custom.msg import (
    PlanGraspsAction,
    PlanGraspsGoal
)
...
class GraspitCommander(object): 
    ...
    def setRobotPose(pose, id=0):
        # graspit_interface/srv/SetRobotPose.srv
    ...
    def planGrasps(cls,
                   ...
                   # Custom: Allow user to specify how many grasps to return
                   n_best_grasps=20,
        ...
        goal = PlanGraspsGoal(graspable_body_id=graspable_body_id,
                              ...
                              # Custom: added an action parameter
                              n_best_grasps=n_best_grasps,
