...
class EGPlanner : public QThread
{
  ...
  protected:
    ...
    bool mRepeat;
    //! Custom: Allows user to specify number of grasps to return
    int mNumBestGrasps;
  ...
  public:
    ...
    //! Custom: allow user to specify number of grasps to return, instead of a constant BEST_LIST_SIZE
    void setNumBestGrasps(int n) {mNumBestGrasps = n;}
