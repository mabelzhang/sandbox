...
#include <robotiq_s_model_articulated_msgs/Float32Srv.h>
...
class RobotiqHandPlugin : public gazebo::ModelPlugin
{
  ...
  // Mabel
  //private: void SetXPrismaticCommand(const std_msgs::Float32::ConstPtr &_msg);
  //private: void SetYPrismaticCommand(const std_msgs::Float32::ConstPtr &_msg);
  private: void SetZPrismaticCommand(const std_msgs::Float32::ConstPtr &_msg);
  //private: void SetXRevoluteCommand(const std_msgs::Float32::ConstPtr &_msg);
  //private: void SetYRevoluteCommand(const std_msgs::Float32::ConstPtr &_msg);
  //private: void SetZRevoluteCommand(const std_msgs::Float32::ConstPtr &_msg);

  //private: bool SetXPrismaticSrv(
  //  robotiq_s_model_articulated_msgs::Float32Srv::Request & req,
  //  robotiq_s_model_articulated_msgs::Float32Srv::Response & resp);

  //private: void SetXPrismaticData(float cmd);
  ...
  private: void UpdatePrismaticPIDControl(gazebo::common::Time curTime,
    double targetPose, int prismatic_jnt_i);
  //private: void UpdateRevolutePIDControl(gazebo::common::Time curTime,
  //  double targetPose, int revolute_jnt_i);

  /// \brief Grab pointers to all the joints.
  /// \return true on success, false otherwise.
  private: bool FindJoints();

  /// Mabel: For gravity compensation
  private: bool FindLinks ();
  ...
  // Mabel
  private: bool GetAndPushBackLink(const std::string& _linkName,
  ...
  /// Mabel: That's 5 total original Robotiq joints.
  ///   Plus one z prismatic joint to lift the hand to test grasp success,
  private: static const int NumJoints = 5;
  // Mabel: Instead of hardcoding indices like they did, just save the indices
  //   as you dynamically find joints!
  //private: int xPrismaticJnti;
  //private: int yPrismaticJnti;
  private: int zPrismaticJnti;
  //private: int xRevoluteJnti;
  //private: int yRevoluteJnti;
  //private: int zRevoluteJnti;
  private: int robotiqJntsStarti;
  // Scissors move, each forefinger individually
  private: int palmF1Jnti;
  private: int palmF2Jnti;
  // Actuated proximal joint of each finger. Distal joint is compliant.
  private: int f1ProximalJnti;
  private: int f2ProximalJnti;
  private: int thumbProximalJnti;

  //private: int xPrismaticLnki;
  //private: int yPrismaticLnki;
  private: int zPrismaticLnki;
  //private: int xRevoluteLnki;
  //private: int yRevoluteLnki;
  //private: int zRevoluteLnki;
  ...
  // Mabel
  // Prismatic
  //private: static const std::string DefaultLeftXPrismaticTopicCommand;
  //private: static const std::string DefaultRightXPrismaticTopicCommand;
  //private: static const std::string DefaultLeftYPrismaticTopicCommand;
  //private: static const std::string DefaultRightYPrismaticTopicCommand;
  private: static const std::string DefaultLeftZPrismaticTopicCommand;
  private: static const std::string DefaultRightZPrismaticTopicCommand;
  // Revolute
  //private: static const std::string DefaultLeftXRevoluteTopicCommand;
  //private: static const std::string DefaultRightXRevoluteTopicCommand;
  //private: static const std::string DefaultLeftYRevoluteTopicCommand;
  //private: static const std::string DefaultRightYRevoluteTopicCommand;
  //private: static const std::string DefaultLeftZRevoluteTopicCommand;
  //private: static const std::string DefaultRightZRevoluteTopicCommand;
  ...
  // Mabel
  //private: ros::Subscriber subXPrismaticCommand;
  //private: ros::Subscriber subYPrismaticCommand;
  private: ros::Subscriber subZPrismaticCommand;
  //private: ros::Subscriber subXRevoluteCommand;
  //private: ros::Subscriber subYRevoluteCommand;
  //private: ros::Subscriber subZRevoluteCommand;

  // Mabel
  //private: ros::ServiceServer srvXPrismatic;
  ...
  // Mabel
  //private: float xPrismaticCommand;
  //private: std_msgs::Float32 yPrismaticCommand;
  private: std_msgs::Float32 zPrismaticCommand;
  //private: std_msgs::Float32 xRevoluteCommand;
  //private: std_msgs::Float32 yRevoluteCommand;
  //private: std_msgs::Float32 zRevoluteCommand;
